...
LL_ATON_DECLARE_NAMED_NN_INSTANCE_AND_INTERFACE(yolov8n192) // Defines NN_Instance_yolov8n192 and NN_Interface_yolov8n192 with network.c info

AI_ALIGNED(32)
static ai_u8 activations_1[0];
AI_ALIGNED(32)
static ai_u8 activations_2[276480];
AI_ALIGNED(32)
...
AI_ALIGNED(32)
static ai_u8 weights_9[3042049];
AI_ALIGNED(32)
...
int main(int argc, char* argv[])
{
  ...
  while(1)
  {
    LL_ATON_RT_Main(&NN_Instance_yolov8n192);
  }
}
