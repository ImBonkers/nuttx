...
#  warning STM32N6 Serial IFLOWCONTROL is untested
#endif
...
#ifdef CONFIG_STM32N6_USART2_SERIALDRIVER
static char g_usart2rxbuffer[CONFIG_USART2_RXBUFSIZE];
static char g_usart2txbuffer[CONFIG_USART2_TXBUFSIZE];
#endif

#ifdef CONFIG_STM32N6_USART3_SERIALDRIVER
static char g_usart3rxbuffer[CONFIG_USART3_RXBUFSIZE];
static char g_usart3txbuffer[CONFIG_USART3_TXBUFSIZE];
#endif

#ifdef CONFIG_STM32N6_UART4_SERIALDRIVER
static char g_uart4rxbuffer[CONFIG_UART4_RXBUFSIZE];
static char g_uart4txbuffer[CONFIG_UART4_TXBUFSIZE];
#endif

#ifdef CONFIG_STM32N6_UART5_SERIALDRIVER
...
/* This describes the state of the STM32N6 USART2 port. */
...
/* This describes the state of the STM32N6 USART3 port. */
...
/* This describes the state of the STM32N6 UART4 port. */
...
/* This describes the state of the STM32N6 UART5 port. */
...
static struct stm32_serial_s * const
  g_uart_devs[STM32N6_NUSART + STM32N6_NUART] =
{
#ifdef CONFIG_STM32N6_USART1_SERIALDRIVER
  [0] = &g_usart1priv,
#endif
...
static void stm32serial_pm_setsuspend(bool suspend)
{
  ...
  for (n = 0; n < STM32N6_NUSART + STM32N6_NUART; n++)
    {
...
static void stm32serial_setapbclock(struct uart_dev_s *dev, bool on)
{
  ...
  switch (priv->usartbase)
    ...
    case STM32_USART2_BASE:
      ...
      regaddr_set = STM32_RCC_APB1ENSR1;
      regaddr_clr = STM32_RCC_APB1ENCR1;
      break;
#endif
#ifdef CONFIG_STM32N6_USART3_SERIALDRIVER
...
void arm_earlyserialinit(void)
{
  ...
  for (i = 0; i < STM32N6_NUSART + STM32N6_NUART; i++)
    {
      if (g_uart_devs[i])
        {
