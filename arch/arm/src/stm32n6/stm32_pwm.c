 ...
 *
 * STM32N6: Timer clock = APB clock (no timer multiplier since PPREx=1).
 * Clock enables use atomic ENSR/ENCR registers.
 * Resets use RSTSR/RSTCR registers.
 */

#define TIMCLK_TIM1      STM32_PCLK2_FREQUENCY
...
#define TIMCLK_TIM2      STM32_PCLK1_FREQUENCY
...
#define TIMCLK_TIM3      STM32_PCLK1_FREQUENCY
...
#define TIMCLK_TIM4      STM32_PCLK1_FREQUENCY
...
#define TIMCLK_TIM5      STM32_PCLK1_FREQUENCY
...
#define TIMCLK_TIM8      STM32_PCLK2_FREQUENCY
...
#define TIMCLK_TIM15     STM32_PCLK2_FREQUENCY
...
#define TIMCLK_TIM16     STM32_PCLK2_FREQUENCY
...
#define TIMCLK_TIM17     STM32_PCLK2_FREQUENCY
