 ...
 *
 * Description:
 *   Enable VddIO supply monitoring for I/O domains used by USART1 and
 *   external peripherals.  On STM32N6, GPIO port E (used for USART1) needs
 *   VddIO2/VddIO3, and XSPI2 needs VddIO4/VddIO5.
 *
 ****************************************************************************/
