...
#    define STM32N6_APBCLOCK         STM32_PCLK2_FREQUENCY
...
#      define STM32N6_CONSOLE_RS485_DIR GPIO_USART1_RS485_DIR
#      if (CONFIG_USART1_RS485_DIR_POLARITY == 0)
#        define STM32N6_CONSOLE_RS485_DIR_POLARITY false
#      else
#        define STM32N6_CONSOLE_RS485_DIR_POLARITY true
#      endif
#    endif
#  elif defined(CONFIG_USART2_SERIAL_CONSOLE)
#    define STM32N6_CONSOLE_BASE     STM32_USART2_BASE
#    define STM32N6_APBCLOCK         STM32_PCLK1_FREQUENCY
#    define STM32N6_CONSOLE_APBREG   STM32_RCC_APB1ENSR1
#    define STM32N6_CONSOLE_APBEN    RCC_APB1ENR1_USART2EN
...
#    define STM32N6_CONSOLE_TX       GPIO_USART2_TX
#    define STM32N6_CONSOLE_RX       GPIO_USART2_RX
#    ifdef CONFIG_USART2_RS485
#      define STM32N6_CONSOLE_RS485_DIR GPIO_USART2_RS485_DIR
...
#    define STM32N6_CONSOLE_BASE     STM32_USART3_BASE
#    define STM32N6_APBCLOCK         STM32_PCLK1_FREQUENCY
#    define STM32N6_CONSOLE_APBREG   STM32_RCC_APB1ENSR1
#    define STM32N6_CONSOLE_APBEN    RCC_APB1ENR1_USART3EN
...
#    define STM32N6_CONSOLE_TX       GPIO_USART3_TX
#    define STM32N6_CONSOLE_RX       GPIO_USART3_RX
#    ifdef CONFIG_USART3_RS485
#      define STM32N6_CONSOLE_RS485_DIR GPIO_USART3_RS485_DIR
...
#    define STM32N6_CONSOLE_BASE     STM32_UART4_BASE
#    define STM32N6_APBCLOCK         STM32_PCLK1_FREQUENCY
#    define STM32N6_CONSOLE_APBREG   STM32_RCC_APB1ENSR1
#    define STM32N6_CONSOLE_APBEN    RCC_APB1ENR1_UART4EN
...
#    define STM32N6_CONSOLE_TX       GPIO_UART4_TX
#    define STM32N6_CONSOLE_RX       GPIO_UART4_RX
#    ifdef CONFIG_UART4_RS485
#      define STM32N6_CONSOLE_RS485_DIR GPIO_UART4_RS485_DIR
...
#    define STM32N6_CONSOLE_BASE     STM32_UART5_BASE
#    define STM32N6_APBCLOCK         STM32_PCLK1_FREQUENCY
#    define STM32N6_CONSOLE_APBREG   STM32_RCC_APB1ENSR1
#    define STM32N6_CONSOLE_APBEN    RCC_APB1ENR1_UART5EN
...
#    define STM32N6_CONSOLE_TX       GPIO_UART5_TX
#    define STM32N6_CONSOLE_RX       GPIO_UART5_RX
#    ifdef CONFIG_UART5_RS485
#      define STM32N6_CONSOLE_RS485_DIR GPIO_UART5_RS485_DIR
...
void arm_lowputc(char ch)
{
  ...
  while ((getreg32(STM32N6_CONSOLE_BASE + STM32_USART_ISR_OFFSET) &
         USART_ISR_TXE) == 0);
#ifdef STM32N6_CONSOLE_RS485_DIR
  stm32_gpiowrite(STM32N6_CONSOLE_RS485_DIR,
                    STM32N6_CONSOLE_RS485_DIR_POLARITY);
#endif
...
void stm32_lowsetup(void)
{
  ...
  /* Enable USART APB clock via atomic SET register (ENSR).
   * Must use ENSR (write-1-to-set) instead of read-modify-write on ENR
   * because the RCC's internal RIF security may block direct ENR access.
   */
...
#ifdef STM32N6_CONSOLE_RS485_DIR
  stm32_configgpio(STM32N6_CONSOLE_RS485_DIR);
  stm32_gpiowrite(STM32N6_CONSOLE_RS485_DIR,
                    !STM32N6_CONSOLE_RS485_DIR_POLARITY);
#endif
