/****************************************************************************
 * arch/arm/src/stm32n6/stm32_pwm.h
 *
...
#ifndef __ARCH_ARM_SRC_STM32N6_STM32_PWM_H
#define __ARCH_ARM_SRC_STM32N6_STM32_PWM_H
 ...
 * If CONFIG_STM32N6_TIMn is defined then the CONFIG_STM32N6_TIMn_PWM must
 * also be defined to indicate that timer "n" is intended to be used for
 * pulsed output signal generation.
 */

#ifndef CONFIG_STM32N6_TIM1
#  undef CONFIG_STM32N6_TIM1_PWM
#endif
#ifndef CONFIG_STM32N6_TIM2
#  undef CONFIG_STM32N6_TIM2_PWM
#endif
#ifndef CONFIG_STM32N6_TIM3
#  undef CONFIG_STM32N6_TIM3_PWM
#endif
#ifndef CONFIG_STM32N6_TIM4
#  undef CONFIG_STM32N6_TIM4_PWM
#endif
#ifndef CONFIG_STM32N6_TIM5
#  undef CONFIG_STM32N6_TIM5_PWM
#endif
#ifndef CONFIG_STM32N6_TIM8
#  undef CONFIG_STM32N6_TIM8_PWM
#endif
#ifndef CONFIG_STM32N6_TIM15
#  undef CONFIG_STM32N6_TIM15_PWM
#endif
#ifndef CONFIG_STM32N6_TIM16
#  undef CONFIG_STM32N6_TIM16_PWM
#endif
#ifndef CONFIG_STM32N6_TIM17
#  undef CONFIG_STM32N6_TIM17_PWM
#endif
...
#undef CONFIG_STM32N6_TIM6_PWM
#undef CONFIG_STM32N6_TIM7_PWM
...
#ifdef CONFIG_STM32N6_PWM_MULTICHAN
 ...
 *
 * CONFIG_STM32N6_TIMx_CHANNEL - Specifies the timer output channel
 *                               {1,..,4}
...
#  if !defined(CONFIG_STM32N6_TIM1_CHANNEL)
#    error "CONFIG_STM32N6_TIM1_CHANNEL must be provided"
#  elif CONFIG_STM32N6_TIM1_CHANNEL == 1
#    define CONFIG_STM32N6_TIM1_CHANNEL1 1
#    define CONFIG_STM32N6_TIM1_CH1MODE  CONFIG_STM32N6_TIM1_CHMODE
#  elif CONFIG_STM32N6_TIM1_CHANNEL == 2
#    define CONFIG_STM32N6_TIM1_CHANNEL2 1
#    define CONFIG_STM32N6_TIM1_CH2MODE  CONFIG_STM32N6_TIM1_CHMODE
#  elif CONFIG_STM32N6_TIM1_CHANNEL == 3
#    define CONFIG_STM32N6_TIM1_CHANNEL3 1
#    define CONFIG_STM32N6_TIM1_CH3MODE  CONFIG_STM32N6_TIM1_CHMODE
#  elif CONFIG_STM32N6_TIM1_CHANNEL == 4
#    define CONFIG_STM32N6_TIM1_CHANNEL4 1
#    define CONFIG_STM32N6_TIM1_CH4MODE  CONFIG_STM32N6_TIM1_CHMODE
#  else
#    error "Unsupported value of CONFIG_STM32N6_TIM1_CHANNEL"
#  endif
#  define PWM_TIM1_NCHANNELS 1
#endif

#ifdef CONFIG_STM32N6_TIM2_PWM
#  if !defined(CONFIG_STM32N6_TIM2_CHANNEL)
#    error "CONFIG_STM32N6_TIM2_CHANNEL must be provided"
#  elif CONFIG_STM32N6_TIM2_CHANNEL == 1
#    define CONFIG_STM32N6_TIM2_CHANNEL1 1
#    define CONFIG_STM32N6_TIM2_CH1MODE  CONFIG_STM32N6_TIM2_CHMODE
#  elif CONFIG_STM32N6_TIM2_CHANNEL == 2
#    define CONFIG_STM32N6_TIM2_CHANNEL2 1
#    define CONFIG_STM32N6_TIM2_CH2MODE  CONFIG_STM32N6_TIM2_CHMODE
#  elif CONFIG_STM32N6_TIM2_CHANNEL == 3
#    define CONFIG_STM32N6_TIM2_CHANNEL3 1
#    define CONFIG_STM32N6_TIM2_CH3MODE  CONFIG_STM32N6_TIM2_CHMODE
#  elif CONFIG_STM32N6_TIM2_CHANNEL == 4
#    define CONFIG_STM32N6_TIM2_CHANNEL4 1
#    define CONFIG_STM32N6_TIM2_CH4MODE  CONFIG_STM32N6_TIM2_CHMODE
#  else
#    error "Unsupported value of CONFIG_STM32N6_TIM2_CHANNEL"
#  endif
#  define PWM_TIM2_NCHANNELS 1
#endif

#ifdef CONFIG_STM32N6_TIM3_PWM
#  if !defined(CONFIG_STM32N6_TIM3_CHANNEL)
#    error "CONFIG_STM32N6_TIM3_CHANNEL must be provided"
#  elif CONFIG_STM32N6_TIM3_CHANNEL == 1
#    define CONFIG_STM32N6_TIM3_CHANNEL1 1
#    define CONFIG_STM32N6_TIM3_CH1MODE  CONFIG_STM32N6_TIM3_CHMODE
#  elif CONFIG_STM32N6_TIM3_CHANNEL == 2
#    define CONFIG_STM32N6_TIM3_CHANNEL2 1
#    define CONFIG_STM32N6_TIM3_CH2MODE  CONFIG_STM32N6_TIM3_CHMODE
#  elif CONFIG_STM32N6_TIM3_CHANNEL == 3
#    define CONFIG_STM32N6_TIM3_CHANNEL3 1
#    define CONFIG_STM32N6_TIM3_CH3MODE  CONFIG_STM32N6_TIM3_CHMODE
#  elif CONFIG_STM32N6_TIM3_CHANNEL == 4
#    define CONFIG_STM32N6_TIM3_CHANNEL4 1
#    define CONFIG_STM32N6_TIM3_CH4MODE  CONFIG_STM32N6_TIM3_CHMODE
#  else
#    error "Unsupported value of CONFIG_STM32N6_TIM3_CHANNEL"
#  endif
#  define PWM_TIM3_NCHANNELS 1
#endif

#ifdef CONFIG_STM32N6_TIM4_PWM
#  if !defined(CONFIG_STM32N6_TIM4_CHANNEL)
#    error "CONFIG_STM32N6_TIM4_CHANNEL must be provided"
#  elif CONFIG_STM32N6_TIM4_CHANNEL == 1
#    define CONFIG_STM32N6_TIM4_CHANNEL1 1
#    define CONFIG_STM32N6_TIM4_CH1MODE  CONFIG_STM32N6_TIM4_CHMODE
#  elif CONFIG_STM32N6_TIM4_CHANNEL == 2
#    define CONFIG_STM32N6_TIM4_CHANNEL2 1
#    define CONFIG_STM32N6_TIM4_CH2MODE  CONFIG_STM32N6_TIM4_CHMODE
#  elif CONFIG_STM32N6_TIM4_CHANNEL == 3
#    define CONFIG_STM32N6_TIM4_CHANNEL3 1
#    define CONFIG_STM32N6_TIM4_CH3MODE  CONFIG_STM32N6_TIM4_CHMODE
#  elif CONFIG_STM32N6_TIM4_CHANNEL == 4
#    define CONFIG_STM32N6_TIM4_CHANNEL4 1
#    define CONFIG_STM32N6_TIM4_CH4MODE  CONFIG_STM32N6_TIM4_CHMODE
#  else
#    error "Unsupported value of CONFIG_STM32N6_TIM4_CHANNEL"
#  endif
#  define PWM_TIM4_NCHANNELS 1
#endif

#ifdef CONFIG_STM32N6_TIM5_PWM
#  if !defined(CONFIG_STM32N6_TIM5_CHANNEL)
#    error "CONFIG_STM32N6_TIM5_CHANNEL must be provided"
#  elif CONFIG_STM32N6_TIM5_CHANNEL == 1
#    define CONFIG_STM32N6_TIM5_CHANNEL1 1
#    define CONFIG_STM32N6_TIM5_CH1MODE  CONFIG_STM32N6_TIM5_CHMODE
#  elif CONFIG_STM32N6_TIM5_CHANNEL == 2
#    define CONFIG_STM32N6_TIM5_CHANNEL2 1
#    define CONFIG_STM32N6_TIM5_CH2MODE  CONFIG_STM32N6_TIM5_CHMODE
#  elif CONFIG_STM32N6_TIM5_CHANNEL == 3
#    define CONFIG_STM32N6_TIM5_CHANNEL3 1
#    define CONFIG_STM32N6_TIM5_CH3MODE  CONFIG_STM32N6_TIM5_CHMODE
#  elif CONFIG_STM32N6_TIM5_CHANNEL == 4
#    define CONFIG_STM32N6_TIM5_CHANNEL4 1
#    define CONFIG_STM32N6_TIM5_CH4MODE  CONFIG_STM32N6_TIM5_CHMODE
#  else
#    error "Unsupported value of CONFIG_STM32N6_TIM5_CHANNEL"
#  endif
#  define PWM_TIM5_NCHANNELS 1
#endif

#ifdef CONFIG_STM32N6_TIM8_PWM
#  if !defined(CONFIG_STM32N6_TIM8_CHANNEL)
#    error "CONFIG_STM32N6_TIM8_CHANNEL must be provided"
#  elif CONFIG_STM32N6_TIM8_CHANNEL == 1
#    define CONFIG_STM32N6_TIM8_CHANNEL1 1
#    define CONFIG_STM32N6_TIM8_CH1MODE  CONFIG_STM32N6_TIM8_CHMODE
#  elif CONFIG_STM32N6_TIM8_CHANNEL == 2
#    define CONFIG_STM32N6_TIM8_CHANNEL2 1
#    define CONFIG_STM32N6_TIM8_CH2MODE  CONFIG_STM32N6_TIM8_CHMODE
#  elif CONFIG_STM32N6_TIM8_CHANNEL == 3
#    define CONFIG_STM32N6_TIM8_CHANNEL3 1
#    define CONFIG_STM32N6_TIM8_CH3MODE  CONFIG_STM32N6_TIM8_CHMODE
#  elif CONFIG_STM32N6_TIM8_CHANNEL == 4
#    define CONFIG_STM32N6_TIM8_CHANNEL4 1
#    define CONFIG_STM32N6_TIM8_CH4MODE  CONFIG_STM32N6_TIM8_CHMODE
#  else
#    error "Unsupported value of CONFIG_STM32N6_TIM8_CHANNEL"
#  endif
#  define PWM_TIM8_NCHANNELS 1
#endif

#ifdef CONFIG_STM32N6_TIM15_PWM
#  if !defined(CONFIG_STM32N6_TIM15_CHANNEL)
#    error "CONFIG_STM32N6_TIM15_CHANNEL must be provided"
#  elif CONFIG_STM32N6_TIM15_CHANNEL == 1
#    define CONFIG_STM32N6_TIM15_CHANNEL1 1
#    define CONFIG_STM32N6_TIM15_CH1MODE  CONFIG_STM32N6_TIM15_CHMODE
#  elif CONFIG_STM32N6_TIM15_CHANNEL == 2
#    define CONFIG_STM32N6_TIM15_CHANNEL2 1
#    define CONFIG_STM32N6_TIM15_CH2MODE  CONFIG_STM32N6_TIM15_CHMODE
#  else
#    error "Unsupported value of CONFIG_STM32N6_TIM15_CHANNEL"
#  endif
#  define PWM_TIM15_NCHANNELS 1
#endif

#ifdef CONFIG_STM32N6_TIM16_PWM
#  if !defined(CONFIG_STM32N6_TIM16_CHANNEL)
#    error "CONFIG_STM32N6_TIM16_CHANNEL must be provided"
#  elif CONFIG_STM32N6_TIM16_CHANNEL == 1
#    define CONFIG_STM32N6_TIM16_CHANNEL1 1
#    define CONFIG_STM32N6_TIM16_CH1MODE  CONFIG_STM32N6_TIM16_CHMODE
#  else
#    error "Unsupported value of CONFIG_STM32N6_TIM16_CHANNEL"
#  endif
#  define PWM_TIM16_NCHANNELS 1
#endif

#ifdef CONFIG_STM32N6_TIM17_PWM
#  if !defined(CONFIG_STM32N6_TIM17_CHANNEL)
#    error "CONFIG_STM32N6_TIM17_CHANNEL must be provided"
#  elif CONFIG_STM32N6_TIM17_CHANNEL == 1
#    define CONFIG_STM32N6_TIM17_CHANNEL1 1
#    define CONFIG_STM32N6_TIM17_CH1MODE  CONFIG_STM32N6_TIM17_CHMODE
#  else
#    error "Unsupported value of CONFIG_STM32N6_TIM17_CHANNEL"
#  endif
#  define PWM_TIM17_NCHANNELS 1
#endif

#endif /* CONFIG_STM32N6_PWM_MULTICHAN */
...
#if defined(CONFIG_STM32N6_TIM1_CH1NOUT) || defined(CONFIG_STM32N6_TIM1_CH2NOUT) || \
    defined(CONFIG_STM32N6_TIM1_CH3NOUT)
#  define HAVE_TIM1_COMPLEMENTARY
#endif
#if defined(CONFIG_STM32N6_TIM8_CH1NOUT) || defined(CONFIG_STM32N6_TIM8_CH2NOUT) || \
    defined(CONFIG_STM32N6_TIM8_CH3NOUT)
#  define HAVE_TIM8_COMPLEMENTARY
#endif
#if defined(CONFIG_STM32N6_TIM15_CH1NOUT)
#  define HAVE_TIM15_COMPLEMENTARY
#endif
#if defined(CONFIG_STM32N6_TIM16_CH1NOUT)
#  define HAVE_TIM16_COMPLEMENTARY
#endif
#if defined(CONFIG_STM32N6_TIM17_CH1NOUT)
...
#endif /* __ASSEMBLY__ */
#endif /* CONFIG_STM32N6_PWM */
#endif /* __ARCH_ARM_SRC_STM32N6_STM32_PWM_H */
