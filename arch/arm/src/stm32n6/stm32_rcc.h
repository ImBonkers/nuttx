...
#if defined(CONFIG_STM32N6_STM32N6XXXX)
#  include "hardware/stm32_rcc.h"
#else
#  error "Unsupported STM32N6 chip"
#endif
 ...
 *   For Phase 1, this verifies HSI is running and enables peripheral clocks.
 *
 * Input Parameters:
 *   None
 *
 ...
 *   For Phase 1, it simply verifies HSI is ready (no PLL).
 *
 ****************************************************************************/
