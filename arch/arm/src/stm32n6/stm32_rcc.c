 ...
 *   For Phase 1, this simply verifies that HSI is running (the default
 *   after reset) and enables peripheral clocks.  No PLL configuration
 *   is performed - the system runs at 64 MHz HSI.
 *
 * Input Parameters:
 *   None
 *
...
void stm32_clockconfig(void)
{
   ...
   * board.h.  For Phase 1, this just verifies HSI is ready.
   */
