...
/* USB HS PHY Controller (USBPHYC) Register Offsets *************************/

#define STM32_USBPHYC_CR_OFFSET       0x0000  /* PHY control register */
#define STM32_USBPHYC_TRIM1CR_OFFSET  0x0004  /* PHY trim register 1 */
#define STM32_USBPHYC_TRIM2CR_OFFSET  0x0008  /* PHY trim register 2 */

/* USBPHYC_CR Register Bitfield Definitions (from CMSIS stm32n657xx.h) */

#define USBPHYC_CR_RETENABLEN1        (1 << 0)  /* Bit 0:  Retention mode enable */
#define USBPHYC_CR_AUTORSMENB1        (1 << 1)  /* Bit 1:  Auto-resume mode enable */
#define USBPHYC_CR_CMN                (1 << 2)  /* Bit 2:  Common block power-down in suspend/sleep */
#define USBPHYC_CR_FSEL_SHIFT         (4)       /* Bits 6:4: PHY reference clock frequency select */
#define USBPHYC_CR_FSEL_MASK          (7 << USBPHYC_CR_FSEL_SHIFT)
#  define USBPHYC_CR_FSEL_12MHZ       (0 << USBPHYC_CR_FSEL_SHIFT) /* 12 MHz */
#  define USBPHYC_CR_FSEL_24MHZ       (2 << USBPHYC_CR_FSEL_SHIFT) /* 24 MHz */
#  define USBPHYC_CR_FSEL_48MHZ       (7 << USBPHYC_CR_FSEL_SHIFT) /* 48 MHz */
#define USBPHYC_CR_OTGDISABLE0       (1 << 16)  /* Bit 16: OTG block disable */
#define USBPHYC_CR_DRVVBUS0          (1 << 17)  /* Bit 17: Drive VBUS */

/* STM32N6-specific GCCFG register bits (different from STM32H7!) */

#define OTG_GCCFG_VBVALOVAL_N6       (1 << 23)  /* Bit 23: VBUSVLDEXT value override */
#define OTG_GCCFG_VBVALEXTOEN_N6     (1 << 24)  /* Bit 24: VBUSVLDEXT override enable */
#define OTG_GCCFG_PULLDOWNEN_N6      (1 << 25)  /* Bit 25: Host pulldown resistors enable */
