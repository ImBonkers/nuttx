 ...
 *
 * In DEV boot mode the CPU runs in Secure state (SAU disabled, ALLNS=0).
 * Peripheral writes via Non-Secure aliases (0x4xxxxxxx) are rejected by
 * RIFSC, causing bus faults.  We must use Secure aliases (0x5xxxxxxx).
 *
...
#define STM32_APB5_BASE       0x56008000    /* APB5 (Secure) */
