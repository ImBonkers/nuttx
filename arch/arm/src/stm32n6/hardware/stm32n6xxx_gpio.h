...
#define STM32_GPION_HSLVR        (STM32_GPION_BASE + STM32_GPIO_HSLVR_OFFSET)
...
#define STM32_GPIOO_HSLVR        (STM32_GPIOO_BASE + STM32_GPIO_HSLVR_OFFSET)
...
#define STM32_GPIOP_HSLVR        (STM32_GPIOP_BASE + STM32_GPIO_HSLVR_OFFSET)
...
#define STM32_GPIOQ_HSLVR        (STM32_GPIOQ_BASE + STM32_GPIO_HSLVR_OFFSET)
