...
#define STM32_SPI_CLK_MAX      200000000UL
...
#define SPI_CR1_RCRCINI           (1 << 14)  /* Bit 14: CRC init pattern control for receiver */
#define SPI_CR1_TCRCINI           (1 << 15)  /* Bit 15: CRC init pattern control for transmitter */
...
#define SPI_CFG1_UDRCFG_SHIFT     (9) /* Bit 9: underrun behavior */
...
#define SPI_CFG1_CRCSIZE_SHIFT    (16)      /* Bits 16-20: length of CRC frame */
...
#define SPI_CFG2_IOSWP            (1 << 15) /* Bit 15: swap MISO and MOSI pins */
...
#define SPI_CFG2_SSM              (1 << 26) /* Bit 26: software management of SS */
                                            /* Bit 27: Reserved */
...
#define SPI_SR_RXPLVL_MASK       (0x3 << SPI_SR_RXPLVL_SHIFT)
#define SPI_SR_RXWNE             (1 << 15) /* Bit 15: RxFIFO word not empty */
#define SPI_SR_CTSIZE_SHIFT      (16)      /* Bits 16-31: number of data frames remaining */
...
#define SPI_I2SCFGR_DATLEN_SHIFT   (8) /* Bits 9:8: Data Length */
#define SPI_I2SCFGR_DATLEN_MASK    (0x3 << SPI_I2SCFGR_DATLEN_SHIFT)

#define SPI_I2SCFGR_CHLEN          (1 << 10) /* Bit 10: Channel Length */
