...
#  undef CONFIG_STM32N6_USART2_SERIALDRIVER
#  undef CONFIG_STM32N6_USART2_1WIREDRIVER
#endif
#if !defined(CONFIG_STM32N6_USART3)
#  undef CONFIG_STM32N6_USART3_SERIALDRIVER
#  undef CONFIG_STM32N6_USART3_1WIREDRIVER
#endif
#if !defined(CONFIG_STM32N6_UART4)
#  undef CONFIG_STM32N6_UART4_SERIALDRIVER
#  undef CONFIG_STM32N6_UART4_1WIREDRIVER
#endif
#if !defined(CONFIG_STM32N6_UART5)
#  undef CONFIG_STM32N6_UART5_SERIALDRIVER
#  undef CONFIG_STM32N6_UART5_1WIREDRIVER
#endif

/* Is there a USART/UART enabled? */

#if defined(CONFIG_STM32N6_USART1) || defined(CONFIG_STM32N6_USART2) || \
    defined(CONFIG_STM32N6_USART3) || defined(CONFIG_STM32N6_UART4)  || \
    defined(CONFIG_STM32N6_UART5)
#  define HAVE_UART 1
#endif
...
#elif defined(CONFIG_USART2_SERIAL_CONSOLE) && defined(CONFIG_STM32N6_USART2_SERIALDRIVER)
...
#  define HAVE_CONSOLE 1
#elif defined(CONFIG_USART3_SERIAL_CONSOLE) && defined(CONFIG_STM32N6_USART3_SERIALDRIVER)
#  undef CONFIG_USART1_SERIAL_CONSOLE
#  undef CONFIG_USART2_SERIAL_CONSOLE
#  undef CONFIG_UART4_SERIAL_CONSOLE
#  undef CONFIG_UART5_SERIAL_CONSOLE
...
#  define HAVE_CONSOLE 1
#elif defined(CONFIG_UART4_SERIAL_CONSOLE) && defined(CONFIG_STM32N6_UART4_SERIALDRIVER)
#  undef CONFIG_USART1_SERIAL_CONSOLE
#  undef CONFIG_USART2_SERIAL_CONSOLE
#  undef CONFIG_USART3_SERIAL_CONSOLE
#  undef CONFIG_UART5_SERIAL_CONSOLE
...
#  define HAVE_CONSOLE 1
#elif defined(CONFIG_UART5_SERIAL_CONSOLE) && defined(CONFIG_STM32N6_UART5_SERIALDRIVER)
#  undef CONFIG_USART1_SERIAL_CONSOLE
#  undef CONFIG_USART2_SERIAL_CONSOLE
#  undef CONFIG_USART3_SERIAL_CONSOLE
#  undef CONFIG_UART4_SERIAL_CONSOLE
