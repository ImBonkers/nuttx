...
#define STM32_IRQ_NPU0            (STM32_IRQ_FIRST + 53)  /* 53:  NPU interrupt 0 */
#define STM32_IRQ_NPU1            (STM32_IRQ_FIRST + 54)  /* 54:  NPU interrupt 1 */
#define STM32_IRQ_NPU2            (STM32_IRQ_FIRST + 55)  /* 55:  NPU interrupt 2 */
#define STM32_IRQ_NPU3            (STM32_IRQ_FIRST + 56)  /* 56:  NPU interrupt 3 */
#define STM32_IRQ_CACHEAXI        (STM32_IRQ_FIRST + 57)  /* 57:  NPU cache interrupt */
